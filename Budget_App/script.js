...
const listCreater = (expenseName, expenseValue) => {
    ...
    sublistContent.classList.add("sublist-content", "flex-sapce")
...
//Add Expenses Through the Click Event 
...
checkAmountButton.addEventListener("click", ()=> {
    ...
    //Enable Buttons 
    // Complete this Function disableButtons(false)
